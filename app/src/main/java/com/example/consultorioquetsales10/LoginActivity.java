...
public class LoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Restaurar el estado de lang_selected
        if (savedInstanceState != null) {
            lang_selected = savedInstanceState.getInt("lang_selected", 0);
        }
    ...
    protected void onSaveInstanceState(Bundle outState) {
        ...
        outState.putInt("lang_selected", lang_selected);
    }
    ...
    private void showDeniedDialog() {
        View view = LayoutInflater.from(this).inflate(R.layout.login_denied_dialog, null);
